...
#include "PositionOneLeftPath.h"

// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR

PositionOneLeftPath::PositionOneLeftPath(): frc::Command() {
...
void PositionOneLeftPath::Initialize() {
...
void PositionOneLeftPath::Execute() {
...
void PositionOneLeftPath::End() {
	Robot::motionProfile->reset();
}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void PositionOneLeftPath::Interrupted() {
