...
ArmPID::ArmPID() : PIDSubsystem("ArmPID", 1.0, 0.0, 0.0) {
    ...
    frc::LiveWindow::GetInstance()->AddActuator("ArmPID", "PIDSubsystem Controller", GetPIDController());
    GetPIDController()->SetInputRange(0.01, 1.0);
    GetPIDController()->SetOutputRange(-1.0, 2.0);
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    armActuator = RobotMap::armPIDArmActuator;
    armPositionSensor = RobotMap::armPIDArmPositionSensor;
